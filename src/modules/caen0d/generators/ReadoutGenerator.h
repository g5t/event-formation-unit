...
/// \file
///
/// \brief Readout generator for Bifrost Bragg data
///
//===----------------------------------------------------------------------===//
...
/**
 * @brief The BifrostBraggDatReader class is responsible for reading data from a DAT
